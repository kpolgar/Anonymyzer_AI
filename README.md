## Anonymyzer_AI
Anonymizer AI is a full stack web app that uses the Clarifai API to find all the faces on a photo and blur them. Ever post a picture for a review online? With this app you can protect your identity and the identify of others in your photos. You can download the edited photo and use it as you wish.
